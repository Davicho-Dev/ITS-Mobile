...
import type { ICreateUserFormProps } from './CreateUserForm.interfaces';

export const CreateUserForm: FC<ICreateUserFormProps> = ({ onSubmit, onReset, isLoading, isError }) => {
	const {
		control,
		formState: { errors },
		handleSubmit,
	...
	return (
		<KeyboardAvoidingView
			...
			style={{ flex: 1 }}
		>
			<ScrollView contentContainerStyle={{ flexGrow: 1, rowGap: 24 }}>
				<FormInput
					label='Nombre'
					name='name'
					placeholder='Nombre'
